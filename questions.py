...
def collect_health_status():
    ...
    st.text_area("Can you describe the main issues or symptoms you’re experiencing?", key="description")
    navigate()
...
def collect_other_info():
    openai_api_key = st.session_state.openai_api_key
    st.text_area("Tell us more about your lifestyle factors, mental health, economic factors.", key="user_more_info")
...
def compile_user_data():
    ...
    user_data = {
        ...
        'decription': st.session_state.get('description', "Not provided"),
