...
def main():
    ...
    st.set_page_config(
        page_title="Efoyta Therapy",
        # page_icon="https://www.svgrepo.com/show/287894/care.svg",
        page_icon= "https://github.com/Muhe43/data/blob/main/mental.png",
        menu_items={
...
def welcome_page():
    ...
    def create_card(title, text, is_active=False):
        return card(
            ...
            #         "background-color":"#ffffff",
                    # "height": "100px",
                    "filter": "drop-shadow(0px 23px 12px rgba(1,1,1,0.10000000149011612))",
                    "border-radius":"30px",
                    "margin": "20px",
                    "padding":"20px 12px",
                    "display":"flex",
    ...
    with col1:
        ...
        create_card("Mental Health Education", "We provide the most accurate mental health information in an easy learning environment suited to different people's needs")
